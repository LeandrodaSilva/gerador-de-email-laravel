                                                        ...
                                                        @else
                                                            <td class="title center-text"
                                                                ...
                                                                <br class="hide-mobile"/><span
                                                                    style="font-family:'Roboto',Arial,Helvetica,sans-serif; font-size:13px; line-height:21px; font-weight:normal;font-style:normal; color:#999;text-decoration:line-through;letter-spacing: 0px;"></span><br/>R${{$item['preco']}}
                                                                <br
                                                                    class="mobile-mobile"/>
                                                            </td>
                                                        @endif
